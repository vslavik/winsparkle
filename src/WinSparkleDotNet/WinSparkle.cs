...
namespace WinSparkleDotNet
{
    public class WinSparkle
    {
        ...
        [DllImport("WinSparkle.dll", EntryPoint = "win_sparkle_set_automatic_check_for_updates", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        private static extern void SetAutomaticCheckForUpdatesInternal([MarshalAs(UnmanagedType.I4)] int enableAutomaticUpdates);
        ...
        [DllImport("WinSparkle.dll", EntryPoint = "win_sparkle_get_automatic_check_for_updates", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("WinSparkle.dll", EntryPoint = "win_sparkle_get_update_check_interval", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I4)]
        public static extern int GetUpdateCheckInterval();


        [DllImport("WinSparkle.dll", EntryPoint = "win_sparkle_get_last_check_time", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I4)]
