...
# this was written by Ronnie for a staright forward call to set pch in Visual Studio
# which requires setting a create with a cpp file
...
MACRO(SET_PRECOMPILED_HEADER targetName hFileName cppFileName)
  ADD_NATIVE_PRECOMPILED_HEADER(${targetName} ${hFileName})
  if(WIN32)
    GET_TARGET_PROPERTY(oldProps "${cppFileName}" COMPILE_FLAGS)
    if (${oldProps} MATCHES NOTFOUND)
      SET(oldProps "")
    endif(${oldProps} MATCHES NOTFOUND)
    SET_SOURCE_FILES_PROPERTIES(${cppFileName} PROPERTIES COMPILE_FLAGS "${oldprops} /Yc\"${hFileName}\"")
  endif(WIN32)
